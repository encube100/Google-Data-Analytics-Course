...
This project is part of requirements in fulfilment of the Google Data Analysis Professional Certificate.

### The Background

Lily Moreno, the director of marketing of Cyclistic, believes that the company’s future growth depends on maximizing the number of annual memberships. Hence, the marketing analyst team objetive is to understand how casual riders and annual members use Cyclistic bikes differently. The results of the analysis could be used to inform designing of a new marketing strategy to convert casual riders into annual members. 


## Statement of the Business task

Whereas, Cyclistic finance analysts already concluded that annual members are much more profitable than casual riders.This project seeks to inform designing of marketing campaign that will result in conversion of casual riders into annual members. 

The Key stakeholders include:

*Lily Moreno* : The director of marketing,Moreno, is responsible for the development of campaigns and initiatives to promote the bike-share program and will seek approval of the campaiGn strategy from Cyclistic Executive Team
*The Cyclistic Executive Team*: The executive team must approve the recommended marketing campaign, as a result the recommendations must be backed by professional data insights and visualizations.

## Data Source

12 zipped .csv files of past 12 month of original bike share data ranging from 01/01/2021 to 31/12/2021 was extracted from [This website](https://divvy-tripdata.s3.amazonaws.com/index.html). The data is made available and licensed by Motivate International Inc under this [license](https://ride.divvybikes.com/data-license-agreement).
...
### The Cyclistic’s historical trip data is:

1. reliable, complete and accurate for the analysis period
2. original, it is a first arty information and original files are backed up in a separate folder.
3. comprehensive i.e. contains all information needed to answer the question.
4. current, bike rider data of the last 12 months was used.
5. cited i.e. vetted by Chicago department of transportation.

### Data Security: tokenization of rider's credit card numbers was done


### Data Limitations: connecting pass purchases to credit cards numbers was not possible since  riders' credit card numbers were hidden.

### Processing Data

I used R for data verification and cleaning.
The combined dataset will have more than 5 million rows of data. Excel worksheet can only handle 1,048,576 rows by 16,384 columns and BigQuery can only export up to 1 GB of data to a single file. 
As such, R was the suitable and used to perform all tasks since it can handle large datasets and faster.


### Data Analysis
#### Setting up the environment

l installed and loaded all packages and librariesreading, cleaning, transforming and analyzing the data.
```{r}
